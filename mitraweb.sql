...
INSERT INTO `ms_menu_m` (`menu_id`, `menu_tittle`, `menu_group`, `link`, `icon`, `queue`, `parent`, `is_active`) VALUES
('MN0001', 'User', '2', 'user', '', 0, '', 'Y'),
('MN0002', 'Profile', '1', '', '', 0, '', 'Y'),
('MN0005', 'Form Medical Record', '2', '', 'fas fa-align-justify', 0, '', 'Y');
