...
(function (a, b) {
	...
	(function (a) {
		...
		function d(a, b, c) {
			return l.push({ prepare: a, sort: b, sortBy: c });
		}
		var e = a,
			f = null,
			g = window,
		...
		return (
			...
			b(
				function (a) {
					for (
						var A = arguments.length, B = Array(1 < A ? A - 1 : 0), C = 1;
						C < A;
						C++
					)
						B[C - 1] = arguments[C];
					...
					function m(e, a, b) {
						for (
							var f = b(e.toString()), g = b(a.toString()), h = 0;
							f[h] && g[h];
							h++
						)
							if (f[h] !== g[h]) {
					...
					function n(a) {
						for (
							var b, c = [], d = 0, e = -1, f = 0, g = void 0, h = void 0;
							(g = (h = a.charAt(d++)).charCodeAt(0));
						...
						for (
							var e = function () {
								...
								var g = !1,
									h = y(d, e),
									o = y(a, e);
								if (e.sortFunction) b = e.sortFunction(d, a);
								else if ("rand" === e.order) b = 0.5 > Math.random() ? 1 : -1;
								else if (h === o) b = 0;
								else {
									if (!e.forceStrings) {
					...
					function u() {
						...
						if (N && b && c)
							Q
								...
								: M
								? M.appendChild(v())
								: f && f.warn && f.warn("parentNode has been removed");
						else {
							var g = "start" === e,
								h = "end" === e,
								i = "first" === e;
					...
					function y(a, b) {
						...
						g &&
							(b.hasFilter
								...
								: (d = d.querySelector(g))),
							b.hasAttr
								? (c = d.getAttribute(b.attr))
								: b.useVal
								? (c = d.value || d.getAttribute("value"))
								: b.hasData
								? (c = d.getAttribute("data-" + b.data))
								: d && (c = d.textContent),
							z(c) &&
								(!b.cases && (c = c.toLowerCase()),
								(c = c.replace(/\s+/g, " ")));
						var h = [e, f, ""].indexOf(c);
					...
					var G = h.createDocumentFragment(),
						...
						Q =
							...
							(D === e || !1 !== D.useFlex) &&
							!P &&
							-1 !== getComputedStyle(O, null).display.indexOf("flex");
					return (
						(r = (function (a) {
							return (
								(0 === a.length && d({})) ||
								c(a, function (a) {
									return d(z(a) ? { selector: a } : a);
								}).length
							);
						})(B)),
						g(),
						I.sort(D.sortFunction || t),
						u(),
						I.map(function (a) {
							return a.elm;
						})
